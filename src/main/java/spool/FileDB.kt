...
class FileDB {
    ...
    init {
        ...
        map["spool.core.Char"] = AstNode.TypeNode("spool.core.Boolean", true, Type("spool.core.object"))
        map["spool.core.String"] = AstNode.TypeNode("spool.core.Boolean", true, Type("spool.core.object"))
        map["spool.core.Array"] = AstNode.TypeNode("spool.core.Boolean", true, Type("spool.core.object"))
        map["spool.core.Func"] = AstNode.TypeNode("spool.core.Boolean", true, Type("spool.core.object"))
        map["spool.core.Void"] = AstNode.TypeNode("spool.core.Boolean", true, Type("spool.core.object"))
        map["spool.core.Console"] = AstNode.TypeNode("spool.core.Boolean", true, Type("spool.core.object"))
        map["spool.core.Random"] = AstNode.TypeNode("spool.core.Boolean", true, Type("spool.core.object"))
